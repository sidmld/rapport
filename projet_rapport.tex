...
\\
\begin{center}
\includegraphics[width=300,height=250]{s.png}} \\ \\
\end{center}
\\
\\
...
\begin{center}
\includegraphics[width=300,height=250]{pg2.png}} \\ \\
\end{center}
...
\begin{center}
\includegraphics[width=300,height=250]{r2.png}} \
\end{center}
...
Pour les alertes et Info, dans \textbf{Symfony} il existe le composant \textbf{SwiftMailer} qui permet de gérer les e-mails. Ce composant contient une classe nommée \textbf{Swift_Mailer} qui envoie  les e-mails. \\
 Le conteneur de service de Symfony peut donc accéder à la classe \textbf{Swift_Mailer}  grâce au service \textbf{mailer} .\\
 \\
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=4cm]{v5.png}
